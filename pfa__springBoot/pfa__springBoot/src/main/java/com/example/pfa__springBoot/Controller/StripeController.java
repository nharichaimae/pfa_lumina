...
import com.example.pfa__springBoot.Interface.StripeInterface;
...
public class StripeController {
    ...
    private final StripeInterface stripePaymentService;

    public StripeController(StripeInterface stripePaymentService) {
