...

  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => 
          import('./historique-paiement/historique-paiement')
            .then(m => m.HistoriqueAdminComponent),
        canActivate: [AuthGuard],
        data: { roles: ['ADMIN'] }
      },
            ...
            //historique
      {
        ...
        loadComponent: () =>
          import('./historique/historique').then(c => c.HistoriqueClientComponent),
        canActivate: [AuthGuard],
        data: { roles: ['CLIENT'] }
      },
      ...
      {
        path: 'abonnement',
        loadComponent: () => import('./components/paiement/abonnement/abonnement').then(c => c.AbonnementComponent),
        canActivate: [AuthGuard],
        data: { roles: ['CLIENT'] }
      },
          // paiement
      {
        path: 'paiement',
        loadComponent: () => import('./components/paiement/paiement').then(c => c.PaiementComponent),
        canActivate: [AuthGuard],
        data: { roles: ['CLIENT'] }
      }
    ]
